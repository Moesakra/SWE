...
public class TimeTableAdapter extends SimpleAdapter  {
    ...
    public TimeTableAdapter(Context context, List <Map<String, String>> items, int loc) {
        super(context, items, R.layout.rowlist, new String[] { "time", "description" }, new int[] { R.id.time, R.id.description });
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.ttrowlist, parent, false);
