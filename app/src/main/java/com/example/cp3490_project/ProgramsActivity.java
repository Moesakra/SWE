...
public class ProgramsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(J.layout.program_activity);

        ListView programListView = (ListView) findViewById(J.id.programListView);
        ...
        programListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!isNetworkAvailable())
                    new AlertDialog.Builder(com.example.cp3490_project.ProgramsActivity.this).
